...
return array(
    ...
    'site' => array(
        ...
        // THE LOGO, IN TWO FILES, ONE PER BACKGROUND. A sun behind a mountain
        // range and the club's name, which the mark did not carry until
        // 2026-08-31. Both are generated from art/logo.png by
        // tools/trace_logo.py, from the SAME trace with one token swapped, so
        // they cannot drift apart.
        //
        //   logo       dark type. For paper: print, a light page, anywhere
        //              this site does not currently put it.
        //   logo_dark  light type. The masthead and the footer, which are ink.
        //
        // BECAUSE THE NAME IS IN THE ARTWORK, nothing that shows one of these
        // may also print "Caltech Alpine Club" as text beside it.
        //
        // Leave logo_dark empty and the masthead falls back to setting the
        // name as text, which is what it did before the artwork had words.
        'logo'        => 'logo.svg',
        'logo_dark'   => 'logo-on-dark.svg',
